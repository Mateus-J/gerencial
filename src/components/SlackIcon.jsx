// Ícone oficial do Slack (as 4 formas coloridas), em SVG inline —
// evita depender de fonte de ícone genérica pro logo de marca.
export default function SlackIcon({ size = 16, className = '' }) {
  return (
    <svg width={size} height={size} viewBox="0 0 122.8 122.8" className={className}>
      <path
