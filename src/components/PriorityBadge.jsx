const STYLES = {
  baixa: 'bg-id-light/15 text-id-dark dark:text-id-light border-id-light/30',
  média: 'bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/30',
  media: 'bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-500/30',
  alta: 'bg-red-500/15 text-red-700 dark:text-red-400 border-red-500/30',
  default: 'bg-[var(--sur2)] text-[var(--tx3)] border-[var(--bdr)]',
}
